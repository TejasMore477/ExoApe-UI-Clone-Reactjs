...
function SpreadNews() {
  return (
    <div className='w-full flex flex-col items-center justify-center text-center  px-5 sm:px-10 py-10'>
      ...
      <h1 className='text-7xl py-5  sm:text-[10rem] sm:w-1/2 sm:font-semibold leading-none tracking-tight'>Spread the News</h1>
      <p className='tracking-tight text-lg'>Find out more about our work on these leading design and technology platforms.</p>
